...
function [pol_r, zer_r] = mypzmap (varargin)
...
%      if (isempty (style))
        pol_args = cat (2, pol_args, pol_re{k}, pol_im{k}, {"x", "color", col,"markersize",3});
zer_args = cat (2, zer_args, zer_re{k}, zer_im{k}, {"o", "color", col,"markersize",3});
%      else
